...
#include "Elasticity/Elasticity_Wendling2024.h"
...
void Simulation::registerNonpressureForces() {
  addDragMethod("None",
                [](FluidModel *) -> NonPressureForceBase * { return nullptr; });
  ...
  addElasticityMethod(
      "None", [](FluidModel *) -> NonPressureForceBase * { return nullptr; });
  ...
  addElasticityMethod("Kugelstadt et al. 2021",
                      Elasticity_Kugelstadt2021::creator);
  addElasticityMethod("Wendling et Cazier. 2024",
                      Elasticity_Wendling2024::creator);

  addSurfaceTensionMethod(
      "None", [](FluidModel *) -> NonPressureForceBase * { return nullptr; });
  addSurfaceTensionMethod("Becker & Teschner 2007",
                          SurfaceTension_Becker2007::creator);
  addSurfaceTensionMethod("Akinci et al. 2013",
                          SurfaceTension_Akinci2013::creator);
  addSurfaceTensionMethod("He et al. 2014", SurfaceTension_He2014::creator);
  addSurfaceTensionMethod("Jeske et al. 2023",
                          SurfaceTension_Jeske2023::creator);
#ifdef USE_THIRD_PARTY_METHODS
  addSurfaceTensionMethod("Zorilla, Ritter, et al. 2020",
                          SurfaceTension_ZorillaRitter2020::creator);
#endif
  ...
  addViscosityMethod("Takahashi et al. 2015 (improved)",
                     Viscosity_Takahashi2015::creator);
